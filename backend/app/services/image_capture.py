...
class ImageCaptureService:
    """Quality-check and persist a room image.

    The service deliberately flushes instead of committing. Transaction
    ownership belongs to the surrounding use case or API boundary.
    """
